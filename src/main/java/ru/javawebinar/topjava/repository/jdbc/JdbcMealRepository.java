...
//    @Autowired
    ...
    public static class hsqldbJdbcRepository extends JdbcMealRepository<Timestamp> {
        ...
        //Timestamp - https://stackoverflow.com/questions/45361743/hsqldb-localdatetime-jdbctemplate
        @Override
        protected Timestamp timeConverter(LocalDateTime dateTime) {
    ...
    public static class postgresJdbcRepository extends JdbcMealRepository<LocalDateTime>  {
        ...
        @Override
        protected LocalDateTime timeConverter(LocalDateTime dateTime) {
            return dateTime;
        }
    }
