...
//                .andExpect(model().attribute("meals", MealsUtil.getTos(MEALS, SecurityUtil.authUserCaloriesPerDay()))) //should work, but dont (
                .andExpect(model().attribute("meals",
                        new AssertionMatcher<List<MealTo>>() {
                            ...
                            public void assertion(List<MealTo> actual) throws AssertionError {
                                ...
                                MEAL_TO_MATCHER.assertMatch(actual, mealToList);
                            }
                        }))
                ;
